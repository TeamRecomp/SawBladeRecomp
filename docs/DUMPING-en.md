...
### Instructions
1. Insert your retail disc copy of Saw into the Xbox 360 disc tray.
...
11. Hold the CTRL key and click on **Saw** under the `Games` node, as well as the **Adventure Pack(s)** under the `DLC` node, if you have the DLC installed. Ensure all are selected before the next step.
